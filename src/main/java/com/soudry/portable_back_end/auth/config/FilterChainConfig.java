...
public class FilterChainConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()).sessionManagement(
            ...
            .oauth2ResourceServer(oauth2 -> oauth2.jwt(jwt -> jwt.jwtAuthenticationConverter(jwtServices.getJwtAuthenticationConverter())));
    ...
    // AuthenticationConfiguration has a method injection
    @Bean
