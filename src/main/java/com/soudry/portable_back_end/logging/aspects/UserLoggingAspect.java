...
public class UserLoggingAspect {
    ...
    @Around("com.soudry.portable_back_end.logging.ModulePointcuts.userFlow()")
    public Object log(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            log.info("[USER DONE] {} {} ms", method, System.currentTimeMillis() - start);
            return result;

        } catch (Throwable ex) {
            log.error("[USER ERROR] {}", method, ex);
            throw ex;
